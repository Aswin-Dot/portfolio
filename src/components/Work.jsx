const projects = [
  ...
  {
    num: '03', name: 'prd-to-tasks', arrow: '↗',
  ...
  {
    num: '04', name: 'screenshotter', arrow: '↗',
  ...
  {
    num: '05', name: 'arcade-games', arrow: '↗',
    desc: '15 mobile games, one codebase, each live on the App Store. Built and shipped solo over two years.',
